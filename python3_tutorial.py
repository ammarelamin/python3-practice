...
# this file starts from python logical statements and follows, doesn't contain variables and data types
...
# km = float(input()) # cus input returns string, we need to convert the string to float
# miles = km / 1.60934
